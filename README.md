...
See the ["API Documentation"](#user-content-api-documentation) section for more a more complete reference on the library and its settings. You can also check out the ["Examples"](user-content-api-examples) section for more complete usage examples.
